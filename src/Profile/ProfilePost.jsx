import { Avatar, Box, Divider, Flex, GridItem, Image,  Modal,  ModalBody,  
ModalCloseButton,  ModalContent,  ModalOverlay,  
Text, useDisclosure, 
...
const {isOpen, onOpen, onClose} = useDisclosure()
  ...
  return ( 
    ...
    position={"relative"} aspectRatio={1/1} onClick={onOpen}>
      ...
      <Flex opacity={0} _hover={{opacity:1}} position={"absolute"} top={0} left={0} 
      right={0} bottom={0} bg={"blackAlpha.700"} transition={"all 0.3s ease"} 
     ...
     <Image src={img} alt="profilepic" w={"100%"} h={"100%"} objectFit={"cover"} />
